            ...
            <div class="container-fluid topmargin">
						...
						<div class="col-md-2 sticky-sidebar-wrap">
							<ul class="list-unstyled items-nav sticky-sidebar">
								...
								<li><hr></li>
								<li><a href="#Lamparas">Lamparas</a></li>
								<li><a href="#Vasos">Vasos</a></li>
							</ul>
						</div>
						<div class="col-md-10">
                        <div class="row">
						...
						?>
								...
								<!-- Shop Item 1
								============================================= -->
								<div class="col-lg-4 col-md-6 mb-4" id="Lamparas">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
													<div class="slider-wrap">
														<div class="slide">
															<a href="#"><img src="product-images<?php echo $product_array[$key]["image"]; ?>" alt="Black Shoe"></a>
														</div>
														<div class="slide">
															<a href="#"><img src="product-images<?php echo $product_array[$key]["image"]; ?>" alt="Black Shoe"></a>
														</div>
                                            ...
                                            <input class="cart-btn button button-white button-light" type="submit" value="Añadir al carrito" > </input>
                                            </form>    
                                        </div>
										<div class="product-desc">
											<div class="product-title">
												<h3><a href="#"><?php echo $product_array[$key]["name"]; ?></a></h3>
												<span><a href="#"><?php echo $product_array[$key]["from"]; ?></a></span>
											</div>
											<div class="product-price"><ins>$<?php echo $product_array[$key]["price"]; ?></ins></div>
										</div>
                                    </div>
						...
						?>
								...
								<!-- Shop Item 1
								============================================= -->
								<div class="col-lg-4 col-md-6 mb-4" id="Vasos">
									<div class="product">
										<div class="product-image position-relative">
											<div class="fslider" data-pagi="false" data-speed="400" data-pause="200000">
												<div class="flexslider">
