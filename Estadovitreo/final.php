...
{	 	
	 ...
	 $shoppingCart->addToCart($nombre,$direccion,$ciudad,$email,$telefono,$transactionid);

	 session_destroy();
	 header("Location: https://estadovitreo.co/");
die();
}
				...
				<div class="container clearfix">
					<div class="row col-mb-50 gutter-50">
						<div class="col-lg-6">
							...
							<form id="billing-form" name="billing-form" class="row mb-0" action="final.php" method="post">

								<div class="col-md-12 form-group">
									<label for="billing-form-name">Nombre:</label>
									<input type="text" id="billing-form-name" name="name" class="sm-form-control" />
                                </div>                                

								<div class="col-12 form-group">
									<label for="billing-form-address">Dirección:</label>
									<input type="text" id="billing-form-address" name="Direccion" class="sm-form-control" />
								</div>

								<div class="col-12 form-group">
									<label for="billing-form-city">Ciudad:</label>
									<input type="text" id="billing-form-city" name="Ciudad" class="sm-form-control" />
								</div>

								<div class="col-md-6 form-group">
									<label for="billing-form-email">Correo electrónico:</label>
									<input type="email" id="billing-form-email" name="email" class="sm-form-control" />
								</div>

								<div class="col-md-6 form-group">
									<label for="billing-form-phone">Teléfono de contacto:</label>
									<input type="text" id="billing-form-phone" name="telefono" class="sm-form-control" />
                                </div>
                                <div class="col-md-6 form-group">
                                    <input hidden="true" value="<?php echo $_SESSION["transactionid"]?>" name="transactionid">
									<input class="button button-dark " type="Submit" value="Enviar" ></input>
                                </div>
